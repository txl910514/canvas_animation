...
var socket,
    ...
    socket_func,
    error_close_setTime;
var dptStatus_data, eqpCount_data, eqpStatus_data, tktStatus_data, patrolStatus_data, completedStatus_data, engineerStatus_data, valuableStatus_data, LifeSupportStatus_data;
...
var INDEX = {
  ...
  no_WebSocket: function no_WebSocket() {
    INDEX.version_ajax();
  ...
  WebSocket_dp: function WebSocket_dp() {
  ...
  version_ajax: function version_ajax() {
  ...
  versionStatus_apply: function versionStatus_apply(result) {
    if (result.success) {
  ...
  eqpCount_ajax: function eqpCount_ajax() {
  ...
  eqpCount_apply: function eqpCount_apply(result) {
    if (result.success) {
  ...
  nameStatus_apply: function nameStatus_apply(name) {
    if (name) {
  ...
  tktStatus_ajax: function tktStatus_ajax() {
  ...
  tktStatus_apply: function tktStatus_apply(result) {
    if (result.success) {
      ...
      result = null, status_total = null, wait_percent = null, get_percent = null, overdue_percent = null, wait_data = null, get_data = null, overdue_data = null;
    }
  },
  patrolStatus_ajax: function patrolStatus_ajax() {
  ...
  patrolStatus_apply: function patrolStatus_apply(result) {
    if (result.success) {
  ...
  valuableStatus_apply: function valuableStatus_apply(result) {
    if (result.success) {
      ...
      data = null, result = null, highValue_sort = null, high_min = null, high_max = null, min_color = null, dot_color = null, add = null;
    }
  },
  LifeSupportStatus_apply: function LifeSupportStatus_apply(result) {
    if (result.success) {
      ...
      result = null, life_data = null, lifeSupport_sort = null, life_min = null, life_max = null, min_color = null, dot_color = null, add = null;
    }
  },
  completedStatus_ajax: function completedStatus_ajax() {
  ...
  completedStatus_apply: function completedStatus_apply(result) {
    if (result.success) {
      var fix_pct_data;
      fix_pct_data = {
        status: 'line',
  ...
  eqpStatus_ajax: function eqpStatus_ajax() {
  ...
  eqpStatus_apply: function eqpStatus_apply(result) {
    if (result.success) {
      ...
      update_sort = _.sortBy(result.data.update_info, function (sort) {
        return -new Date(sort.updated_at); //return sort.updated_at.charCodeAt() * -1;
      });
      ...
      url = null, screen_height = null, result = null, $overdue_tpl = null, $update_tpl = null, update_sort = null, overdue_sort = null;
    }
  },
  dptStatus_ajax: function dptStatus_ajax() {
  ...
  dptStatus_apply: function dptStatus_apply(result) {
    if (result.success) {
      ...
      result = null, dptuse_data = null, lack_length = null, dptusePct_sort = null, dptuse_min = null, dptuse_color = null, x1_value = null;
    }
  },
  engineerStatus_ajax: function engineerStatus_ajax() {
  ...
  engineerStatus_apply: function engineerStatus_apply(result) {
    if (result.success) {
      ...
      GVR.INTERVAL.info_setInterval = setInterval(function () {
        ...
        $medical_info_line.animate({
          ...
          $medical_info_line.css({
            top: '0px'
          });
        });
      }, 60 * 1000);
      url = null, $medical_info_box = null, result = null, $medical_tpl = null;
    }
  },
  device_num_total: function device_num_total($ele, num) {
    var start = 0;
    var str_num = '0000';
    var html_num;
  ...
  switch_num: function switch_num(start) {
